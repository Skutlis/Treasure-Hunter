...
public class TestMap extends GameMap {
    ...
    public void initItems() {
        items.add(new Treasure(2f*TILE_SIZE, 11f*TILE_SIZE, ItemType.EMERALD, true));
        items.add(new Treasure(39f*TILE_SIZE, 10f*TILE_SIZE, ItemType.CHEST, true));
        items.add(new Weapon(4f*TILE_SIZE, 11f*TILE_SIZE , ItemType.FIREBALL, 5f*TILE_SIZE, 10, 50*TILE_SIZE, 200, true));
    }

    @Override
    public void initMap() {
        tiledMap = new TmxMapLoader().load("src\\test\\resources\\testmap.tmx");
